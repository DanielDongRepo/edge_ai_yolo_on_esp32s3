...
#define BSP_LCD_DC            (GPIO_NUM_0)//43
#define BSP_LCD_RST           (GPIO_NUM_NC)//NC
 ...
 * Camera interface
 *
 * ESP-Orderist-BSP is shipped with OV2640 camera module.
 ...
 **************************************************************************************************/
/**
 * @brief ESP-Orderist-BSP camera default configuration
 *
 ...
 * LCD interface
 *
 * ESP-Orderist-BSP is shipped with 1.3inch ST7789 display controller.
 ...
 **************************************************************************************************/
#define BSP_LCD_PIXEL_CLOCK_HZ     (1 * 1000 * 1000)
