...
#define BSP_CAPS_SDCARD         0//1
#define BSP_CAPS_IMU            1
#define BSP_CAPS_CAMERA         1

/**************************************************************************************************
 * ESP-OrderistV2-BSP pinout
 **************************************************************************************************/
...
/* Display */
#define BSP_LCD_SPI_MOSI      (GPIO_NUM_1)//   47旧 0-1.8    1新 0-3.3
#define BSP_LCD_SPI_CLK       (GPIO_NUM_21)//0-3.3
#define BSP_LCD_SPI_CS        (GPIO_NUM_45)//0-3.3v
#define BSP_LCD_DC            (GPIO_NUM_2)//    0旧 boot扰乱    2新  0-3.3v
#define BSP_LCD_RST           (GPIO_NUM_NC)//3.3
#define BSP_LCD_BACKLIGHT     (GPIO_NUM_46)//0-3.3
...
/* 实际启用的物理按键数量：只保留 BOOT 按键（GPIO0）。
 * 原4个ADC按键已从 bsp_button_config 移除以释放 GPIO1 给 LCD MOSI。
 * 详见 esp_orderist_v2_bsp.c 的 bsp_button_config 定义。*/
#define BSP_BUTTON_INSTALLED_NUM   (1)
 ...
 * Camera interface
 *
 * ESP-OrderistV2-BSP is shipped with OV2640 camera module.
 ...
 **************************************************************************************************/
/**
 * @brief ESP-OrderistV2-BSP camera default configuration
 *
 ...
 * LCD interface
 *
 * ESP-OrderistV2-BSP is shipped with 1.3inch ST7789 display controller.
